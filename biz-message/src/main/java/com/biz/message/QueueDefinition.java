...
public interface QueueDefinition{
	/**
	 * 队列签名<p>
	 * 规则:[exchangeName:[routingKey:]]queueName<p>
	 * 形如:com.biz.demoexchange:myroutingkey:smsqueue<br>
	 * 	->解出队列名问smsqueue,交换机名为com.biz.demoexchange,路由键为myroutingkey<p>
	 * 或:com.biz.demoexchange:smsqueue<br>
	 * 	->解出队列名为smsqueue,交换机名为com.biz.demoexchange,路由键与队列名相同<p>
	 * 或:smsqueue<br>

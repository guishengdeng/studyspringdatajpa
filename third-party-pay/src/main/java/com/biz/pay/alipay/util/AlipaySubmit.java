package com.biz.pay.alipay.util;

import com.biz.pay.alipay.config.AlipayConfig;
import com.biz.pay.alipay.sign.MD5;
import com.biz.pay.alipay.sign.RSA;
import com.biz.pay.alipay.util.httpClient.HttpProtocolHandler;
import com.biz.pay.alipay.util.httpClient.HttpRequest;
import com.biz.pay.alipay.util.httpClient.HttpResponse;
import com.biz.pay.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
    ...
    public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
        if (Objects.equals(AlipayConfig.sign_type, "RSA")) {
            mysign = RSA.sign(prestr, AlipayConfig.private_key, AlipayConfig.input_charset);
        } else if(Objects.equals(AlipayConfig.sign_type, "MD5")) {
            mysign = MD5.sign(prestr, AlipayConfig.sign_key, AlipayConfig.input_charset);
        }
        return mysign;
    }
    ...
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod,
        ...
        sbHtml.append(
            "<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
     ...
     * @throws Exception
     */
    public static String buildRequest(String strParaFileName, String strFilePath,
	...
	public static String query_timestamp()
        ...
        String strUrl =
            ALIPAY_GATEWAY_NEW + "search=query_timestamp&partner=" + AlipayConfig.partner

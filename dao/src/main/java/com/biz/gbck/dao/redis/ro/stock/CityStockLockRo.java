 ...
 * @date 2016年12月5日
 */
@Ro(key = "stock:city:lock")
public class CityStockLockRo extends BaseRedisObject<String> {
    ...
    public CityStockLockRo() {
        super();
    }

    public CityStockLockRo(Integer cityId, String productCode, Integer quantity) {
        this();

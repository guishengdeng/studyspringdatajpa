 ...
 * @date 2016年12月5日
 */
@Ro(key = "stock:province:lock")
@RoSortedSet(key = "list", score = "createTimestamp")
public class ProvinceStockLockRo extends BaseRedisObject<String> {
    ...
    public ProvinceStockLockRo() {
        super();
    }

    public ProvinceStockLockRo(Integer provinceId, String productCode, Integer quantity) {
        this();

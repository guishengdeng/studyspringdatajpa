...
<gbck:sidebar icon="fa fa-list" fixed="true">
    ...
    <gbck:menuGroup text="按销售状态展示" icon="fa fa-shopping-basket">
        ...
        <gbck:singleMenu text="已经预订的猫" link="demo/cats/listBySaleStatus.do?saleStatus=LOCK" />
        <gbck:singleMenu text="已售的猫" link="demo/cats/listBySaleStatus.do?saleStatus=SOLD" />
    </gbck:menuGroup>
</gbck:sidebar>